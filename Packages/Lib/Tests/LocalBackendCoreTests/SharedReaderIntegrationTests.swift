...
@Suite(
    "SharedReaderKey Backend Integration Tests",
    .dependencies {
...
struct SharedReaderKeyIntegrationTests {
    ...
    func swiftUIViewModelPattern() async throws {
        ...
        final class ProjectListViewModel {
            ...
            @SharedReader(.projectVersionStrings) var versionStrings:
                [String: [String]] = [:]
    ...
    func loadingStatesAndErrorHandling() async throws {
        ...
        @SharedReader(.project(id: "com.example.nonexistent")) var project:
            ProjectValue? = nil
    ...
    func dynamicKeySwitching() async throws {
        ...
        // Start with project1
        @SharedReader(.project(id: "com.example.project1"))
        var currentProject: ProjectValue? = nil
    ...
    func complexDataRelationships() async throws {
        ...
        final class ProjectDetailViewModel {
            ...
            init(projectId: String) {
                ...
                self.projectDetailReader = SharedReader(
            ...
            var projectDetail: ProjectDetailData? {
                projectDetailReader.wrappedValue
            }
        ...
        let viewModel = ProjectDetailViewModel(
            projectId: "com.example.detailtest"
        )
    ...
    func differentDataTypes() async throws {
        ...
        @SharedReader(.projectVersionStrings) var dictionary:
            [String: [String]] = [:]
        @SharedReader(.project(id: "test")) var optional: ProjectValue? =
            nil
